...
public class _11_Package {
	public static void main(String[] args) {
		...
		System.out.println("랜덤 정수 : " + random.nextInt()); // int 의 범위 내에서의 정수형 값 반환
...
//		System.out.println("랜덤 실수 (범위) : " + random.nextDouble(10.0)); 불가
		...
		// nextInt(45) + 1 : 1 이상 46 미만의수 == 1 이상 45 이하의 수
		
		// Math, Scanner, StringBuilder, StringBuffer, StringTokkenizer
